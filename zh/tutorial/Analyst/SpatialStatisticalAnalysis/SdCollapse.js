...
function copyright()
{
	document.write('版权所有&copy; 2007-2018 北京超图软件股份有限公司。保留所有权利。');
}

function UpdateDate()
{
	document.write("本页面最新更新日期:   "   +(new   Date(document.lastModified)).getFullYear()   +"."+   ((new   Date(document.lastModified)).getMonth()+1)   +"."+(new   Date(document.lastModified)).getDate()     +   "");
}
