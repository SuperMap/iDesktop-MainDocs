...
![](../../img/smalltitle.png) [打开符号库窗口的途径](OpenSymManager.htm)

![](../../img/smalltitle.png) [管理符号资源](ResourcesManagerUI.htm)

![](../../img/smalltitle.png) [符号库窗口中的右键菜单](SymManagerContextMenu.htm)
