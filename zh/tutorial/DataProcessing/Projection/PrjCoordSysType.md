...
title: 坐标系的类型  
---  
在 SuperMap iDesktop 中，数据的坐标系分为三类：平面坐标系、地理坐标系、投影坐标系。

### [平面坐标系](PlaneCoordSysDia.htm)
