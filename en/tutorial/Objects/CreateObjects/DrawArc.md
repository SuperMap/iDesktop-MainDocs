...
![](img-en/Arc1.png) | ![](img-en/Arc2.png) | ![](img-en/Arc3.png) | ![](img-en/Arc4.png)  
---|---|---|---  
...
The arcs in the line dataset are all common line objects. It only records the coordinates of nodes on line. But the arc objects drawed in the CAD dataset are the parameterized objects. It will record the corresponding parameters, such as the radius and center, etc.
